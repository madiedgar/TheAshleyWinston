			...
			<div id="primary_footer">
	    		...
	    		<?php
					...
					if(get_option("hazel_footer_number_cols") == "three"){
						...
						/* WITH MADI CO UPDATE: one row footer for mobile
...
*/
						if(get_option("hazel_footer_columns_order") == "one_three"){ ?>
 							<div class="footer_sidebar col-xs-4 col-md-4"><?php hazel_print_sidebar('footer-three-column-left'); ?></div>
 							<div class="footer_sidebar col-xs-4 col-md-4"><?php hazel_print_sidebar('footer-three-column-center'); ?></div>
 							<div class="footer_sidebar col-xs-4 col-md-4"><?php hazel_print_sidebar('footer-three-column-right'); ?></div>
 						<?php }
